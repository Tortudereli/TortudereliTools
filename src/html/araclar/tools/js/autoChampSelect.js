...
getChampions.forEach(element => {
    if (element['id'] !== -1) {
        $('#autoMatchingBanChamp').append(`<option value="${element['id']}">${element['name']}</option>`);
    }
});

var getPickableChampions = ipcRenderer.sendSync("get", `/lol-champions/v1/owned-champions-minimal`)['body'];

getPickableChampions.forEach(element => {
    if (element['id'] != -1) {
        if (element['freeToPlay'] == true && element['ownership']['owned'] == false) {
            $('#autoMatchingSelectChamp').append(`<option value="${element['id']}">${element['name']} *</option>`);
        } else {
            $('#autoMatchingSelectChamp').append(`<option value="${element['id']}">${element['name']}</option>`);
        }
    }
...
var primaryRune1 = 0,
    ...
    primaryRune3 = 0,
    primaryRune4 = 0,
    primaryStyleText, primaryStyleValue;
$("#autoMatchingPrimaryStyle").change(() => {
    ...
    if (primaryStyleValue != 0) {
        ...
        $.getJSON(`js/json/${runeDataName}Runes.json`, function (data) {
            ...
            $("#autoMatchingSubStyle").append(`<option id="defaultSubStyle" value="0">- İkincil Rün Seç -</option>`);
            $.getJSON("js/json/perkStyle.json", function (data1) {
                data1.forEach(element => {
                    if (primaryStyleText != element['name']) {
                        $("#autoMatchingSubStyle").append(`<option value="${element['value']}">${element['name']}</option>`);
            ...
            data.forEach(element => {
                perkData.forEach(element1 => {
                    if (element['value'] == element1['id']) {
                        ...
                        if (primaryStyleText == "İsabet" || primaryStyleText == "Hakimiyet") {
                            if (i <= 4) {
                                $("#primaryPerksArea").append(`<img class="ilkSira" id="${element['value']}" src="${ipcRenderer.sendSync("getImg", runeImgUrl)['body']}" alt="${i}" data-bs-delay="100" data-bs-placement="top" data-bs-toggle="tooltip" data-bs-html="true" data-bs-original-title="${runeLongDesc}">`);
                                $(`#${element['value']}`).click(() => {
                                ...
                                if (i <= 7) {
                                    $("#primaryPerksArea").append(`<img class="ikinciSira" id="${element['value']}" src="${ipcRenderer.sendSync("getImg", runeImgUrl)['body']}" alt="${i}" data-bs-delay="100" data-bs-placement="top" data-bs-toggle="tooltip" data-bs-html="true" data-bs-original-title="${runeLongDesc}">`);
                                    $(`#${element['value']}`).click(() => {
                                    ...
                                    $("#primaryPerksArea").append(`<img class="ucuncuSira" id="${element['value']}" src="${ipcRenderer.sendSync("getImg", runeImgUrl)['body']}" alt="${i}" data-bs-delay="100" data-bs-placement="top" data-bs-toggle="tooltip" data-bs-html="true" data-bs-original-title="${runeLongDesc}">`);
                                    $(`#${element['value']}`).click(() => {
                                ...
                                $("#primaryPerksArea").append(`<img class="sonSira" id="${element['value']}" src="${ipcRenderer.sendSync("getImg", runeImgUrl)['body']}" alt="${i}" data-bs-delay="100" data-bs-placement="top" data-bs-toggle="tooltip" data-bs-html="true" data-bs-original-title="${runeLongDesc}">`);
                                $(`#${element['value']}`).click(() => {
                        ...
                        } else if (primaryStyleText == "Büyücülük" || primaryStyleText == "Azim" || primaryStyleText == "İlham") {
                            if (i <= 3) {
                                $("#primaryPerksArea").append(`<img class="ilkSira" id="${element['value']}" src="${ipcRenderer.sendSync("getImg", runeImgUrl)['body']}" alt="${i}" data-bs-delay="100" data-bs-placement="top" data-bs-toggle="tooltip" data-bs-html="true" data-bs-original-title="${runeLongDesc}">`);
                                $(`#${element['value']}`).click(() => {
                                    $(".ilkSira").css("opacity", "0.3");
                ...
                perkData.forEach(element1 => {
                    if (element['value'] == element1['id']) {
                        ...
                        if (subStyleText == "İsabet" || subStyleText == "Hakimiyet") {
                            if (data[0]['value'] != element['value'] && data[1]['value'] != element['value'] && data[2]['value'] != element['value'] && data[3]['value'] != element['value']) {
                                if (i <= 3) {
                                    $("#subPerksAreaRune").append(`<img class="subIlkSira" id="${element['value']}" src="${ipcRenderer.sendSync("getImg", runeImgUrl)['body']}" alt="" data-bs-delay="100" data-bs-placement="top" data-bs-toggle="tooltip" data-bs-html="true" data-bs-original-title="${runeLongDesc}">`);
                                    $(`#${element['value']}`).click(() => {
                                        ...
                                        } else if (subRuneKontrol2 == true && subRuneKontrol3 == false) {
                                            $(".subIlkSira").css("opacity", "0.3");
                                            $(`#${element['value']}`).css("opacity", "unset");
                                            subRuneKontrol1 = true;
                                            subRune2 = element['value'];
                                        } else if (subRuneKontrol2 == false && subRuneKontrol3 == true) {
                                            $(".subIlkSira").css("opacity", "0.3");
                                            $(`#${element['value']}`).css("opacity", "unset");
                                            subRuneKontrol1 = true;
                                            subRune2 = element['value'];
                                    ...
                                    $("#subPerksAreaRune").append(`<img class="subIkinciSira" id="${element['value']}" src="${ipcRenderer.sendSync("getImg", runeImgUrl)['body']}" alt="" data-bs-delay="100" data-bs-placement="top" data-bs-toggle="tooltip" data-bs-html="true" data-bs-original-title="${runeLongDesc}">`);
                                    $(`#${element['value']}`).click(() => {
                                        if (subRuneKontrol1 == false && subRuneKontrol3 == false) {
                                            ...
                                            subRune1 = element['value'];
                                        } else if (subRuneKontrol1 == true && subRuneKontrol3 == false) {
                                            $(".subIkinciSira").css("opacity", "0.3");
                                            $(`#${element['value']}`).css("opacity", "unset");
                                            subRuneKontrol2 = true;
                                            subRune2 = element['value'];
                                        } else if (subRuneKontrol1 == false && subRuneKontrol3 == true) {
                                            $(".subIkinciSira").css("opacity", "0.3");
                                            $(`#${element['value']}`).css("opacity", "unset");
                                            subRuneKontrol2 = true;
                                            subRune2 = element['value'];
                                    ...
                                    $("#subPerksAreaRune").append(`<img class="subSonSira" id="${element['value']}" src="${ipcRenderer.sendSync("getImg", runeImgUrl)['body']}" alt="" data-bs-delay="100" data-bs-placement="top" data-bs-toggle="tooltip" data-bs-html="true" data-bs-original-title="${runeLongDesc}">`);
                                    $(`#${element['value']}`).click(() => {
                                        if (subRuneKontrol1 == false && subRuneKontrol2 == false) {
                                            ...
                                            subRune1 = element['value'];
                                        } else if (subRuneKontrol1 == true && subRuneKontrol2 == false) {
                                            $(".subSonSira").css("opacity", "0.3");
                                            $(`#${element['value']}`).css("opacity", "unset");
                                            subRuneKontrol3 = true;
                                            subRune2 = element['value'];
                                        } else if (subRuneKontrol1 == false && subRuneKontrol2 == true) {
                                            $(".subSonSira").css("opacity", "0.3");
                                            $(`#${element['value']}`).css("opacity", "unset");
                                            subRuneKontrol3 = true;
                                            subRune2 = element['value'];
                        ...
                        } else if (subStyleText == "Büyücülük" || subStyleText == "Azim" || subStyleText == "İlham") {
                            if (data[0]['value'] != element['value'] && data[1]['value'] != element['value'] && data[2]['value'] != element['value']) {
                                if (i <= 3) {
                                    $("#subPerksAreaRune").append(`<img class="subIlkSira" id="${element['value']}" src="${ipcRenderer.sendSync("getImg", runeImgUrl)['body']}" alt="" data-bs-delay="100" data-bs-placement="top" data-bs-toggle="tooltip" data-bs-html="true" data-bs-original-title="${runeLongDesc}">`);
                                    $(`#${element['value']}`).click(() => {
                                        if (subRuneKontrol2 == false && subRuneKontrol3 == false) {
...
$("#subPerksAreaStat11").attr("src", ipcRenderer.sendSync("getImg", getRuneData(5008)['iconPath'])['body']);
$("#subPerksAreaStat12").attr("src", ipcRenderer.sendSync("getImg", getRuneData(5005)['iconPath'])['body']);
$("#subPerksAreaStat13").attr("src", ipcRenderer.sendSync("getImg", getRuneData(5007)['iconPath'])['body']);
$("#subPerksAreaStat21").attr("src", ipcRenderer.sendSync("getImg", getRuneData(5008)['iconPath'])['body']);
$("#subPerksAreaStat22").attr("src", ipcRenderer.sendSync("getImg", getRuneData(5002)['iconPath'])['body']);
$("#subPerksAreaStat23").attr("src", ipcRenderer.sendSync("getImg", getRuneData(5003)['iconPath'])['body']);
$("#subPerksAreaStat31").attr("src", ipcRenderer.sendSync("getImg", getRuneData(5001)['iconPath'])['body']);
...
$("#subPerksAreaStat21").attr("data-bs-original-title", getRuneData(5008)['longDesc']);
$("#subPerksAreaStat22").attr("data-bs-original-title", getRuneData(5002)['longDesc']);
$("#subPerksAreaStat23").attr("data-bs-original-title", getRuneData(5003)['longDesc']);
$("#subPerksAreaStat31").attr("data-bs-original-title", getRuneData(5001)['longDesc']);
$("#subPerksAreaStat32").attr("data-bs-original-title", getRuneData(5002)['longDesc']);
$("#subPerksAreaStat33").attr("data-bs-original-title", getRuneData(5003)['longDesc']);
...
$("#runeSubmit").change(() => {
    $("#submitAutoAccept").prop('checked', false);
    if (primaryRune1 == 0 || primaryRune2 == 0 || primaryRune3 == 0 || primaryRune4 == 0 || subRune1 == 0 || subRune2 == 0 || statRune1 == 0 || statRune2 == 0 || statRune3 == 0) {
...
var spell1 = 0,
    spell2 = 0,
    spellStatus = false;
var summonerSpellData = ipcRenderer.sendSync("getApi", "https://raw.communitydragon.org/latest/plugins/rcp-be-lol-game-data/global/tr_tr/v1/summoner-spells.json")['body'];
summonerSpellData.forEach(element => {
    if (summonerLevel >= element['summonerLevel']) {
        element['gameModes'].forEach(element1 => {
            if (element1 == "CLASSIC") {
                $("#autoMatchingSelectSpell1").append(`<option value="${element['id']}">${element['name']}</option>`);
            }
        });
    }
});
...
$("#autoMatchingSelectSpell1").change(() => {
    ...
    $("#autoMatchingSelectSpell2").append(`<option id="defaultSelectSpell2" value="0">- F büyüsü seç -</option>`);
    summonerSpellData.forEach(element => {
        if (summonerLevel >= element['summonerLevel']) {
            element['gameModes'].forEach(element1 => {
                if (element1 == "CLASSIC" && $("#autoMatchingSelectSpell1 option:selected").text() != element['name']) {
                    $("#autoMatchingSelectSpell2").append(`<option value="${element['id']}">${element['name']}</option>`);
                }
            });
        }
    });
...
setInterval(() => {
    ...
    if (submitAutoAccept == true) {
        ...
        if (ipcRenderer.sendSync("get", "/lol-champ-select/v1/session")['status'] == 200) {
            if (banChampId != 0) {
                try {
                    var oldI = 0;
                    var oldJ = 0;
                    var data = ipcRenderer.sendSync("get", "/lol-champ-select/v1/session")['body'];
                    for (let i = 0; i < data['actions'].length; i++) {
                        for (let j = 0; j < data['actions'][i].length; j++) {
                            if (data['actions'][oldI][oldJ]['championId'] == banChampId && data['actions'][oldI][oldJ]['type'] == "ban") {
                                break;
                            } else {
            ...
            if (selectChampId != 0) {
                try {
                    ...
                    for (let i = 0; i < data['actions'].length; i++) {
                        for (let j = 0; j < data['actions'][i].length; j++) {
                            if (data['actions'][oldI][oldJ]['championId'] == selectChampId && data['actions'][oldI][oldJ]['type'] == "pick") {
                                break;
                            } else {
            ...
            if (runeSubmit == true && runeStatus == false) {
                try {
                    var currentPageId = ipcRenderer.sendSync("get", "/lol-perks/v1/currentpage")['body'];
